"""
Deploy Pre-Trained TensorFlow Lite Inception V3
===============================================
By Kuen-Wey Lin
...
model_path = './inception_v3_int8.tflite'
input_name = 'input_1'
...
# ---------------------------------------------
# TFLite Top-1 accuracy: 74.00%; Top-5 accuracy: 94.00% (50 images)
'''
...
# -----------------------------------
# TVM Top-1 accuracy: 72.00%; Top-5 accuracy: 96.00% (50 images)
